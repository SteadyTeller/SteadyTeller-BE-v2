...
class MemberGoalServiceTest {
    ...
    void createGoalRejectsReversedDates() {
        ...
        MemberStudyInfoRequestDto request = request(
                LocalDate.now().plusMonths(2), LocalDate.now().plusMonths(1), List.of("MON"));
    ...
    void createGoalRejectsInvalidOrDuplicateAvailableDays() {
        ...
        MemberStudyInfoRequestDto request = request(
                LocalDate.now().plusDays(1), LocalDate.now().plusMonths(1), List.of("MON", "MON"));
    ...
    void createGoalRejectsUnknownAvailableDay() {
        ...
        MemberStudyInfoRequestDto request = request(
                LocalDate.now().plusDays(1), LocalDate.now().plusMonths(1), List.of("Monday"));
